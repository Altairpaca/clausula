...
def evaluate_execution_contract(
    ...
    *,
    ...
    `violation` means the proposed action is deterministically blocked.
    `unavailable` means a required execution fact is missing, producing a
    conditional result rather than an optimistic pass.
    """
