...
def register_execution_capabilities(
    ...
    registry.register(
        CapabilitySpec(
            ...
            True,
            "Stores a normalized versioned control artifact and tamper-evident audit event; does not create transactions.",
        ),
    ...
    registry.register(
        CapabilitySpec(
            ...
            ("execution:write",),
            True,
            "Appends normalized constraints with explicit effective/knowledge time and provenance.",
        ),
    ...
    registry.register(
        CapabilitySpec(
            ...
            ("execution:read",),
            False,
            "Selects one version using effective and known cutoffs; never infers a missing contract.",
        ),
    ...
    registry.register(
        CapabilitySpec(
            ...
            False,
            "Projects recommendation/planning actions through versioned market/account execution constraints without creating orders.",
        ),
